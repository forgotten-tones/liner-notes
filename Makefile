...
build: clean gen $(PUBLISH_DIR)/assets $(PUBLISH_DIR)/CNAME $(PUBLISH_DIR)/README.md
...
$(PUBLISH_DIR)/assets:
	...
	@cp -r assets site/
	@rm -r site/assets/.git site/assets/.gitignore site/assets/README.md
